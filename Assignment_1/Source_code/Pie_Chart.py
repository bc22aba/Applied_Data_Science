# -*- coding: utf-8 -*-
"""
Created on Sat Feb 25 12:44:38 2023
...
'''Data link: https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_population'''
'''Read Excel file Data using pandas'''
def ReadData():
    return pd.read_excel('D:/WorkSpace/Applied_Data_Science/Assignment_1/Data_sets/Pie_Chart_DataSet.xlsx')
